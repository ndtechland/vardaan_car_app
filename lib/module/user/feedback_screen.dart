...
import '../../controller/employee_controllers/feedback_controller.dart';
import '../../theme_color/theme_color.dart';

class FeedbackScreen extends StatelessWidget {
  final GlobalKey<FormState> _formconnectionfedbackKey = GlobalKey<FormState>();

  FeedbackEmployeeController _feedbackEmployeeController =
      Get.put(FeedbackEmployeeController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => _feedbackEmployeeController.isLoading.value
            ? Center(
                child: CircularProgressIndicator(),
              )
            : SafeArea(
                child: Form(
                  key: _feedbackEmployeeController.feedbackemployeeFormKey,
                    ...
                    children: [
                      ...
                      Directionality(
                        ...
                        child: CustomTextField(
                          controller:
                              _feedbackEmployeeController.passwordController1,
                          maxLines: 9,
                          obscureText: false,
                      ...
                      HorizontalCircularButton(
                        ...
                        text: "SUBMIT",
                        onPressed: () {
                          if (_feedbackEmployeeController
                                  .feedbackemployeeFormKey.currentState
                                  ?.validate() ??
                              false) {
                            _feedbackEmployeeController.checkFeedback(context);
                          }
                          ;
                        },
